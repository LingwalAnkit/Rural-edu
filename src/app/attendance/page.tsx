  ...
  return (
    <>
      <div className="flex h-screen bg-blue-900">
        <SidebarComponent />
        <div className="flex-1 p-10 overflow-y-auto bg-blue-200">
          <h2 className="text-2xl font-semibold mb-8 text-blue-900">
            Teacher Attendance Tracker
          </h2>

          <div className="bg-blue-400 shadow-md rounded-lg p-6 mb-8">
            ...
            {attendanceData.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="w-full border-collapse bg-blue-800 rounded-lg overflow-hidden">
                  <thead className="bg-blue-500">
                    <tr>
                      <th className="border border-blue-600 p-3 text-left text-white">
                        Timestamp
                      </th>
                      <th className="border border-blue-600 p-3 text-left text-white">
                        Latitude
                  ...
                  <tbody>
                    {attendanceData.map((record, index) => (
                      <tr key={index} className="hover:bg-blue-600">
                        <td className="border border-blue-600 p-3 text-white">
                          {record.Timestamp}
                        </td>
                        <td className="border border-blue-600 p-3 text-white">
